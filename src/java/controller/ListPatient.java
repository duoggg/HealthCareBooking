 ...
 * @author DELL
 */
@WebServlet(name="ListPatient", urlPatterns={"/lispa"})
public class ListPatient extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListPatient</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListPatient at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
...
//        }else{
            page= 1;   //bs 
            page2 = Integer.parseInt(xpage2);  // bn
             page3 =1;
        //}
        int start; int end;
