 ...
 * @author DELL
 */
@WebServlet(name="transferdatgoi", urlPatterns={"/transferdatgoi"})
public class transferdatgoi extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet transferdatgoi</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet transferdatgoi at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        String idser= request.getParameter("id");
